...
export default function ActivityList({ activities, dispatch }: ActivityListProps) {
  ...
  return (
    <>
      ...
      {
        isEmptyActivities ? <p className="text-center text-slate-500 my-5">No hay actividades</p> :
          activities.map(activity => (
            <div key={activity.id} className="px-5 py-10 bg-white mt-5 flex justify-between swodow">
              ...
              <div className="flex gap-5 items-center">
                ...
                <button onClick={() => dispatch({ type: 'detele-activity', payload: { id: activity.id } })}>
                  <XCircleIcon
